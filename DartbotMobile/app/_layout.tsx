    ...
    <PaperProvider theme={paperTheme}>
      <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
        ...
        >
          ...
          <Stack.Screen name="screens/H2HRecordScreen" options={{ title: 'H2H Record', headerLargeTitle: true }} />
          <Stack.Screen name="screens/StatisticsScreen" options={{ title: 'Statistics', headerLargeTitle: true }} />
